    ...
    <div v-if="userProfile">
        ...
        <div class="mdui-card mdui-hoverable mdui-m-t-2">
          ...
          <div class="mdui-card-header">
            ...
            <div class="mdui-card-header-title">
              {{ userProfile.userAccount }}[{{ userProfile.userPri.userPrivilegeDesc }}]
            </div>
      ...
      <div id="funCategory" class="mdui-container mdui-m-t-1">
        ...
        <div class="mdui-tab mdui-tab-full-width mdui-color-theme-0" mdui-tab>
          ...
          <a v-if="!darkMode" @click="toggleDark()" href="#example6-tab2" class="mdui-ripple">
            <i class="mdui-icon material-icons">brightness_3</i>
            <label>夜间模式</label>
          </a>
          <a v-else @click="toggleDark()" href="#example6-tab2" class="mdui-ripple">
