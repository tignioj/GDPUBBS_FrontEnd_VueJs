<template>
  <div class="mdui-container">
    <form method="post" id="form" enctype="application/x-www-form-urlencoded">
      ...
      <div class="mdui-textfield">
        <textarea name="blockMinDesc" v-model="blockMinDesc" class="mdui-textfield-input" maxlength="10000"
  ...
  export default {
    ...
    methods: {
      ...
      submit () {
        ...
        updateBlockMin(formData, config).then(res => {
          ...
          if (obj.code === 0) {
            ...
            mdui.snackbar({
              ...
              buttonText: '取消',
              onClick: function () {
                self.$router.replace('/blockmin/detail/' + self.blockMinUid)
              },
      ...
      loadBlockMinDetails (uid) {
        ...
        reqBlockMinDetail(uid).then(re => {
          ...
          self.blockMinName = re.blockMinName
          self.blockMinDesc = re.blockMinDesc
          self.blockMinUid = re.blockMinUid
        }).catch(e => {
          console.error(e)
        })
      }
