<template>
  <div v-if="blockminDetail">
    <div class="mdui-container">
      ...
      <!--            v-for="(bm, index)  in posts" :key="index"-->
      <!--        >-->
      <!--          <div class="mdui-list-item-content">-->
      <!--            <div class="mdui-list-item-title mdui-list-item-one-line">{{bm.blockMinName}}-->
      <!--              {{bm.blockMinCreatedTime|date-format}}-->
      <!--            </div>-->
      <!--            <div class="mdui-list-item-text mdui-list-item-two-line">{{bm.blockMinDesc}}</div>-->
      <!--          </div>-->
      <!--        </li>-->
      <!--      </ul>-->
